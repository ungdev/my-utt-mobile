  ...
  render() {
    return (
      <ScrollView contentContainerStyle={styles.container}>
        <Text style={styles.title}>Bienvenu sur l'application My UTT !</Text>
        <Text style={styles.h}>Historique</Text>
        <Text style={styles.p}>
          Cette application a été créée par l'UTT Net Group (UNG), l'association
          d'informatique de l'UTT. Elle a été développée initiallement par
          Arnaud Dufour.
        </Text>
        <Text style={styles.p}>
          L'UNG a développé et maintient un site étudiant depuis 2002, dont de
          multiples versions se sont succédés. La version actuelle du site
        ...
        <Text style={styles.p}>
          Quelques années après sa création, l'émergeance des smartphones dans
        ...
        <Text style={styles.p}>
          ...
          Nous avons alors décidé de réaliser cette application, orienté plus
        ...
        <Text style={styles.p}>
          ...
          de cette application est publique, tu peux nous proposer tes
        ...
        <Text style={styles.p}>
          ...
          nous rapporter des bugs, nous proposers des améliorations ou même si
          tu en es capable nous faire des design.
        </Text>
      </ScrollView>
    )
  }
